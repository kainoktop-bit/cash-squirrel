...
// this formula -- api/send-monthly-report.ts and api/_lineAssistant.ts both import it instead
// of each computing their own version that can silently drift from the app's real numbers.
