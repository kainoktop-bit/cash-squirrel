...
const PRO_FEATURES = [
  ...
  'เชื่อมต่อ LINE รับการ์ดแจ้งเตือนทุกครั้งที่บันทึก/ลบงานและรายจ่าย พิมพ์ถามข้อมูลหรือบันทึกงานผ่านแชทได้ทันที',
  'สรุปงานค้างชำระรายวันทางอีเมลและ LINE ไม่ต้องเปิดแอปเองก็รู้ว่าใครยังไม่จ่าย'
];
